...
public class PanelLogin extends JPanel {
    ...
    public PanelLogin() {
        ...
        add(lblNewLabel);
        lblNewLabel.setIcon(new ImageIcon(new ImageIcon ("Multimedia/Logo.png").getImage().getScaledInstance(lblNewLabel.getWidth(), lblNewLabel.getHeight(), Image.SCALE_SMOOTH)));
        ...
        textFieldPass.setBorder(new EmptyBorder(5, 5, 5, 5)); 
        add(textFieldPass);
