...
public class PanelLogin extends JPanel {
	...
	public PanelLogin() {
		...
		JLabel lblNoTienesUsuario = new JLabel("No tienes Usuario Pincha aqui");
		lblNoTienesUsuario.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblNoTienesUsuario.setForeground(Color.BLUE);
		lblNoTienesUsuario.setBounds(208, 356, 275, 55);
		add(lblNoTienesUsuario);
